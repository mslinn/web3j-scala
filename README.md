...
[![Gitter chat](https://badges.gitter.im/web3j-scala/gitter.png)](https://gitter.im/web3j-scala/Lobby)
...
Add this to your SBT project's `build.sbt`:
    ...
    libraryDependencies += "com.micronautics" %% "web3j-scala" % "0.2.1" withSources()
